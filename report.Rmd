...
params$missing_plots2_reac[1]
params$missing_plots2_reac[2]
...
### Before batch correction
```{r}
params$hca_before_bc_reac
```

### After combat only correction
```{r}
params$hca_after_across_bc_reac
```

### After combat+loess correction
```{r}
params$hca_after_bc_reac

if (identical(rmarkdown::metadata$runtime, "shiny"))
  shiny::setProgress(0.75)  # set progress to 100%
```
